...
ReceiveIncrementCapacitor={}
ReceiveDecrementCapacitor={}
ReceiveDigitUpDown={}

SendIncrementCapacitor={}
SendDecrementCapacitor={}
SendDigitUpDown={}
for i=1,6 do
...
local duplexPushToToggle=createPushToToggle()
...
ReceiveIncrements={}
ReceiveDecrements={}
ReceiveDigits={0,0,0,0,0,0}

SendIncrements={}
SendDecrements={}
SendDigits={0,0,0,0,0,0}
...
function onTick()
	...
	if ScreenMode=="Menu" then
		...
		local duplexButton=isPressed and isPointInRectangle(inputX,inputY,w/2-11,h/2+8+VerticalGap*4,20,6)
